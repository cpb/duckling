...
Gem::Specification.new do |spec|
  ...
  # Resolves reference_zone:'s per-date IANA offsets (called from both
  # lib/duckling.rb and, in this alt architecture, ext/duckling/src/lib.rs's
  # resolve_naive seam) -- the wrapped duckling crate and this gem's own
  # Magnus binding only understand chrono::FixedOffset, with no
  # DST-transition concept, so that has to come from a real timezone
  # database on the Ruby side instead.
