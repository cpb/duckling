...
# answer a question at all — the gate behind `stale_tolerant`.
#
...
#
# - **Modelling.** Debian and Ubuntu compile tzdata in rearguard format, which
#   strips negative DST, and move the backward-compat links to a `tzdata-legacy`
...
module TZCapabilities
  ...
  # predicate that answers it. Going through this map rather than calling the
  ...
  # and `stale_tolerant` consults exactly it.
