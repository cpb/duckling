...
For a faster edit-compile-test loop, run `bundle exec rake dev compile test`
to build the extension in Cargo's dev profile instead of release — slower at
runtime, but much faster to compile while iterating.
