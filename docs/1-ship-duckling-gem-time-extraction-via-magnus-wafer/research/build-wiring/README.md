...
| File | Description |
|------|-------------|
| [extension-crate.md](extension-crate.md) | The new `ext/duckling/` Rust crate that must be created: cdylib type, Cargo.toml shape, `build.rs` question, and open dependency questions for wafer-inc-duckling. |
