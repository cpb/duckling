...
- [type-mapping-strategy/](./type-mapping-strategy/README.md) — Options for converting [duckling](https://github.com/wafer-inc/duckling) Rust types to Ruby (serde_magnus vs. manual Magnus mapping vs. JSON round-trip), verified serde attribute analysis, and the target Ruby hash schema.
- [test-coverage/](./test-coverage/README.md) — Time corpus cases from [duckling](https://github.com/wafer-inc/duckling) (1300+ lines), Ruby minitest test suite design with fixed reference time, and pyduckling parity scope for 0.2.0.
...
| test-coverage | Hill tests already written in PR #2 (`test/duckling_test.rb`); they assert symbol keys. Fixed reference time 2013-02-12 04:30:00 UTC-2 matches [duckling](https://github.com/wafer-inc/duckling) corpus. |
